        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center mb-3">
                <h3 class="mb-0 text-primary fw-bold">
                    <i class="menu-icon tf-icons bx bx-map"></i> Data ODP / Area
                </h3>
                ...
                <div class="d-flex flex-wrap align-items-center gap-2">
                    ...
                    <div class="d-none d-md-flex">
                        <a href="<?= base_url('admin/Data_ODP/C_Tambah_ODP') ?>" class="btn btn-primary">
                    ...
                    <!-- Aksi untuk Mobile -->
                    <div class="d-md-none">
                        <a href="<?= base_url('admin/Data_ODP/C_Tambah_ODP') ?>" class="btn btn-primary w-100">
                            <i class="bi bi-plus-lg me-1"></i> Tambah
                        </a>
                    </div>
                </div>
