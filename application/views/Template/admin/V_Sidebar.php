        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="<?php echo base_url('admin/C_Dashboard_Admin') ?>" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">Nakasy</span>
                    </a>
